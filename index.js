...
const BarBarKey = 'Apikey kalian, kalau ada'; //APIKEY MHANKBARBAR
const TobzKey = 'apikey kalian, kalau ada'; //APIKEY Tobz
		...
		case 'lvl':
               ...
               client.sendMessage(from, resul, text, { quoted: mek})
				...
				case 'ingfokan':
					...
					teks = `*Nama bot* : ${me.name}\n*OWNER* : *ganti nama kalian*\n*AUTHOR* : ganti nama kalian\n*Nomor Bot* : @${me.jid.split('@')[0]}\n*Prefix* : ${prefix}\n*Total Block Contact* : ${blocked.length}\n*The bot is active on* : ${kyun(uptime)}` //ganti nama kalian
